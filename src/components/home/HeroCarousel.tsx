...
// 手机端：品牌海报（原 mobile slide-6）放第一张，其余按原序排列。共 6 张，全部唯一。
const MOBILE_ORDER = [6, 1, 2, 3, 4, 5];

const SLIDES = MOBILE_ORDER.map((m, i) => ({
  src: `/images/carousel/slide-${i + 1}.jpg`,
  mobileSrc: `/images/carousel/mobile/slide-${m}.png`,
}));
